import{_ as k,r as n,c as r,a as e,F as u,d as l,h as M,t as a,u as b,f as o,n as w,b as I}from"./index-BfRxaVdO.js";const _={class:"message-queue-container"},Q={class:"courses-section"},R={class:"course-cards"},S=["onClick"],f={class:"course-description"},D={class:"course-duration"},C={class:"course-topics"},q={class:"demo-section"},L={class:"demo-cards"},O=["onClick"],N={key:0,class:"demo-detail"},U={class:"code-block"},T={__name:"index",setup(x){const m=b(),g=n([{id:1,title:"消息队列基础入门",description:"从零开始，系统学习消息队列的核心概念和实践应用",duration:"3小时",level:"入门",topics:["什么是消息队列？为什么需要它？","消息队列的基本工作流程","消息队列的三大核心概念：生产者、消费者、消息","消息队列的四种常见模式：点对点、发布订阅、请求响应、广播","消息队列的五大应用场景：异步处理、流量削峰、解耦系统、消息通知、日志处理","主流消息队列产品对比：RocketMQ vs Kafka vs RabbitMQ","消息队列的可靠性保证：消息持久化、消息确认、消息重试","消息队列的常见问题与解决方案"]},{id:2,title:"RocketMQ 实战",description:"深入学习 RocketMQ 的使用方法和最佳实践",duration:"4小时",level:"中级",topics:["RocketMQ 安装与配置","主题与标签详解","消息存储机制","消息重试与死信处理","集群部署方案"]},{id:3,title:"Kafka 高级应用",description:"掌握 Kafka 的高级特性和性能优化技巧",duration:"6小时",level:"高级",topics:["Kafka 架构设计","分区与副本机制","消息压缩与性能优化","监控与运维","安全机制实现"]}]),i=n(null),p=n([{id:1,title:"消息队列基础概念演示",description:"通过简单的示例理解消息队列的核心概念",code:`// 1. 生产者（Producer）示例
const producer = {
  sendMessage: (message) => {
